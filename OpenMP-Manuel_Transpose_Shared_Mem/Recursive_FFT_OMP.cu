...
float Recursive_FFT_OpenMP::getCpuTime()
{
    return cpuTime;
}

float Recursive_FFT_OpenMP::getGPUTime()
{
    return gpuTime;
}

std::vector<Complex> Recursive_FFT_OpenMP::getCpuResult()
{
    return cpuResult;
}

std::vector<Complex> Recursive_FFT_OpenMP::getGpuResult()
{
    return gpuResult;
}
